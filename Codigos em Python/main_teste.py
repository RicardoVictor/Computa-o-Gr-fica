...
def piramide_triangular(textura):    
    ...
    piramide.addVertice(0, 0, 7)
    piramide.addVertice(7, 0, 0)
    piramide.addVertice(0, 7, 0)
...
piramide1 = piramide_triangular(textura)
piramide2 = piramide_triangular(textura)
piramide3 = piramide_triangular(textura)
...
piramide1.aplica(R3 @ R2 @ R1 @ T1)

T2 = translacao(-7, 0, 0)
piramide2.aplica(T2 @ R3 @ R2 @ R1 @ T1)

T3 = translacao(7, 0, 0)
piramide3.aplica(T3 @ R3 @ R2 @ R1 @ T1)
